...
<div class="container">
    <div class="row">
        ...
        <form action="{{ url('admin/banner') }}" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data">
            
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                       
                <div class="form-group">    
                    <label class="control-label col-sm-2" for="title">Add Banner</label>
                    <div class="col-sm-4">
